...
import (
	...
	"github.com/rafal-jan/weighted-deployment-controller/internal/controller"
...
func init() {
	...
	utilruntime.Must(weightedv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "21e2dab1.example.com",
	...
	if err = (&controller.WeightedDeploymentReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "WeightedDeployment")
		os.Exit(1)
	}
